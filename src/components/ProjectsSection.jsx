  ...
  return (
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto  max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, key) => (
            ...
            >
              ...
              {/**div nay chua cac phan noi dung text */}
              <div className="py-6">
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag) => (
                    <span className="px-2 py-1 text-xs font-medium border rounded-full bg-secondary text-secondary-foregound">
                      {tag}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex justify-center items-center">
                  <div className="flex space-x-3">
                    <a
                      ...
                      target="_blank"
                      className="text-foreground/80 hover:text-primary transition-colors dration-300"
                    >
        ...
        {/**div nay chua link chi den profile tren github */}
        <div className="text-center mt-12">
          <a
            href="https://github.com/ngqkhoi31"
            target="_blank"
